...
For each of these sensors used, metadata containing the features(location, height above sea level...) was collected, you can find the details [here]( zindi.africa/competitions/airqo-ugandan-air-quality-forecast-challenge/data).
